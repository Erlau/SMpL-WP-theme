...
/**
 * Embed page inside another page with shortcode. [my_content id="Enter your page id number" title=Set this to true if you want to show title /]
 */
